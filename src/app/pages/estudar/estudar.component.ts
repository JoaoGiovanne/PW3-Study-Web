...
import { DisciplinaService } from 'src/app/services/disciplina.services';
...
export class EstudarComponent {
  ...
  constructor(private disciplinaService: DisciplinaService){
    disciplinaService.buscarDisciplina().subscribe(resposta => {this.disciplinas = resposta});
    disciplinaService.excluirDisciplina().subscribe(resposta => {this.disciplinas = resposta});
